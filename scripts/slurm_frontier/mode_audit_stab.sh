...
#SBATCH -A fus187
#SBATCH -J stabscat
#SBATCH -o logs/%j_stabscat.out
#SBATCH -e logs/%j_stabscat.err
#SBATCH -t 1:30:00
#SBATCH -p batch
#SBATCH -N 1
...
MODALITIES="${MODALITIES:-ece,co2}" NWIN_PER_SHOT="${NWIN_PER_SHOT:-500}" \
OUT_DIR="${OUT_DIR:-analysis/mode_audit}" python analysis/mode_audit/stability_scatter.py
echo "[stabscat] done"
