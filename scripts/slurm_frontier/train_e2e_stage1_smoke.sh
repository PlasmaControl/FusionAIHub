#!/bin/bash
#SBATCH -A fus187
#SBATCH -J e2e_stage1_smoke
#SBATCH -o logs/%j_e2e_stage1_smoke.out
#SBATCH -e logs/%j_e2e_stage1_smoke.err
#SBATCH -t 2:00:00
#SBATCH -p batch
#SBATCH -N 2
...
cd "${PROJECT_DIR}"
CHECKPOINT_DIR="/lustre/orion/fus187/proj-shared/models/e2e_stage1_smoke"
mkdir -p logs "${CHECKPOINT_DIR}"

# Distinct port from production stage1 (29500) and stage2 (29502) so a
# concurrent run doesn't collide on the rendezvous port.
