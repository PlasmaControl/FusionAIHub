#!/bin/bash
#SBATCH -A fus187
#SBATCH -J e2e_stage2_delta_smoke
#SBATCH -o logs/%j_e2e_stage2_delta_smoke.out
#SBATCH -e logs/%j_e2e_stage2_delta_smoke.err
#SBATCH -t 1:00:00
#SBATCH -p batch
#SBATCH -N 2
...
CHECKPOINT_DIR="/lustre/orion/fus187/proj-shared/models/e2e_stage2_delta_smoke"
# Repointed 2026-05-20: Stage-1.5 refine-stack (12/4) now in code; the
# May-15 e2e_stage1_smoke checkpoint has the OLD 4/2 refine arch and will
# not load. Use the current production Stage-1.5 best instead.
...
# Distinct port from production stage1 (29500), stage2 (29502), and the
# stage-1 smoke (29510).
