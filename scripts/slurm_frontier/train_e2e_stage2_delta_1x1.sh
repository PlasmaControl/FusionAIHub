#!/bin/bash
# Frontier DDP launcher: train_e2e Stage2 Delta — 1 node × 1 GCD (single-GPU smoke / dev)
#
# Usage:
#   sbatch scripts/slurm_frontier/train_e2e_stage2_delta_1x1.sh
#
...
#   sbatch -N 8 -t 12:00:00 scripts/slurm_frontier/train_e2e_stage2_delta_1x1.sh
#
#SBATCH -A fus187
#SBATCH -J e2e_s2d_1x1
#SBATCH -o logs/%j_e2e_s2d_1x1.out
#SBATCH -e logs/%j_e2e_s2d_1x1.err
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -N 1
...
echo "${SMOKE_BANNER}[stage2_delta/1x1] nodes=$NODES total_ranks=$TOTAL_RANKS \
batch=$BATCH_SIZE steps=$MAX_STEPS K_max=$K_MAX"
echo "${SMOKE_BANNER}[stage2_delta/1x1] master=$MASTER_ADDR:$MASTER_PORT data=$DATA_DIR"
