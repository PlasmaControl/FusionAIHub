...
# 1x1 launcher exercises the same model + modality mix at single-GCD scale.
...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-/lustre/orion/fus187/proj-shared/models/e2e_stage1_1x1}"
