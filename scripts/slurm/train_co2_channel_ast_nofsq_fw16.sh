...
# Channel-AST, no FSQ, no channel merge, frame_width=16
# Token count: 4 channels × ceil(1954/16) = 4 × 123 = 492 tokens × 256 d_model
# Compression: 8x (frame_width only, per-frame 8:1)
