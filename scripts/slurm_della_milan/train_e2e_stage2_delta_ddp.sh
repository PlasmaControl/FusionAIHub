...
#SBATCH --error=logs/%j_e2e_stage2_delta_ddp.err
...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-runs/e2e_stage2_delta_ddp}"
...
echo "[ddp_stage2_delta] gpus=$GPUS nproc=$NPROC batch=$BATCH_SIZE steps=$MAX_STEPS K_max=$K_MAX"
