...
def merge_times_1d(
    ...
    return time_matching_merge_asof_1d(
        time1, data1, time_std, left_window, right_window
    )


# reference
@staticmethod
def time_matching_merge_asof_1d(
    time1: np.ndarray,
    data1: np.ndarray,
    time_std: np.ndarray,
    left_window: int = 0,
    ...
    merged_df = pd.merge_asof(
        df2, df1, left_on="time_std", right_on="time1", direction="nearest"
    )
