...
def signal_gen(diag_name='zipfit',sig_names_custom=[''],names_custom=[''],tree_custom=''):
    ...
    if diag_name=='neutron':
        ...
        sig_name_with_d=['mpid66m020', 'mpid66m020', 'mpid66m067', 'mpid067u', 'mpid66m097', 'mpid097u', 'mpid66m127', 'mpid127u', 'mpid66m157', 'mpid157u', 'mpid66m200', 'mpid66m247', 'mpid66m277', 'mpid66m307', 'mpid66m340', 'mpid67a022', 'mpid67a037', 'mpid67a052', 'mpid67a067', 'mpid67a082', 'mpid67a097', 'mpid67a142', 'mpid67a217', 'mpid67a262', 'mpid67a277', 'mpid67a307', 'mpid67a337', 'mpid67b022', 'mpid67b037', 'mpid67b052', 'mpid67b097', 'mpid67b157', 'mpid67b217', 'mpid67b277', 'mpid67b337', 'mpid79a072', 'mpid79a147', 'mpid79a222', 'mpid79a272', 'mpid79b067', 'mpid79b142', 'mpid79b217', 'mpid79b277', 'mpid1a011', 'mpid1a049', 'mpid1a109', 'mpid1a139', 'mpid1a199', 'mpid1a244', 'mpid1a274', 'mpid1a341', 'mpid1b011', 'mpid1b049', 'mpid1b109', 'mpid1b139', 'mpid1b199', 'mpid1b244', 'mpid1b274', 'mpid1b341', 'mpid5a199', 'mpid4a199', 'mpid3a199', 'mpid2a199', 'mpid1a199', 'mpid1b199', 'mpid2b199', 'mpid3b199', 'mpid4b199', 'mpid5b199', 'isld66m017', 'isld66m042', 'isld66m072', 'isld079u', 'isld66m102', 'isld66m132', 'isld139u', 'isld66m197', 'isld199u', 'isld66m252', 'isld66m312', 'isld67a017', 'isld67a052', 'isld67a072', 'isld67a112', 'isld67a132', 'isld67a197', 'isld67a252', 'isld67a312', 'isld67b017', 'isld67b052', 'isld67b072', 'isld67b112', 'isld67b132', 'isld67b197', 'isld67b252', 'isld67b312', 'isld79a072', 'isld79a147', 'isld79a222', 'isld79a272', 'isld79b067', 'isld79b142', 'isld79b217', 'isld79b277', 'isld1a011', 'isld1a049', 'isld1a109', 'isld1a139', 'isld1a199', 'isld1a244', 'isld1a274', 'isld1a341', 'isld1b011', 'isld1b049', 'isld1b109', 'isld1b139', 'isld1b199', 'isld1b244', 'isld1b274', 'isld1b341', 'isld5a199', 'isld4a199', 'isld3a199', 'isld2a199', 'isld1a199', 'isld1b199', 'isld2b199', 'isld3b199', 'isld4b199', 'isld5b199', 'esld66m019', 'esld66m079', 'esld079u', 'esld66m139', 'esld139u', 'esld66m199', 'esld199u', 'esld66m259', 'esld66m319', 'esld079', 'esld139', 'esld199', 'esld67a004', 'esld67a034', 'esld67a064', 'esld67a094', 'esld67a124', 'esld67a154', 'esld67a184', 'esld67a214', 'esld67a244', 'esld67a274', 'esld67a304', 'esld67a334', 'esld67b004', 'esld67b034', 'esld67b064', 'esld67b094', 'esld67b124', 'esld67b154', 'esld67b184', 'esld67b214', 'esld67b244', 'esld67b274', 'esld67b304', 'esld67b334', 'btid66m053', 'btid66m132', 'btid66m233', 'btid66m312']
        ...
        if tree_custom=='ptdata':
            ...
            signals.append(MdsSignal(name, tree_custom, location='remote://atlas.gat.com'))
        ...
        names=['dsl.1u180', 'dsl.2u180', 'dsl.3u180', 'dsl.4u157', 'dsl.5u157', 'dsl.6u157', \
                'mpi.11m067', 'mpi.11m322', 'mpi.1a139', 'mpi.1a322', 'mpi.1b139', 'mpi.1b157', 'mpi.1b322', \
                ...
                'psf.1a', 'psf.1b', 'psf.2a', 'psf.2b', 'psf.3a', 'psf.3b', 'psf.4a', 'psf.4b', \
                'psf.5a', 'psf.5b', 'psf.6fa', 'psf.6fb', 'psf.6na', 'psf.6nb', 'psf.7fa', \
                'psf.7fb', 'psf.7na', 'psf.7nb', 'psf.8a', 'psf.8b', 'psf.9a', 'psf.9b', \
                'psi.11m', 'psi.12a', 'psi.12b', 'psi.1l', 'psi.23a', 'psi.23b', 'psi.2l', 'psi.34a', \
                ...
                with h5py.File(f'{path}{shot}_{diag_name}.h5', 'w') as hf:
                    for key in data_h5.keys():
                        ...
                        for subkey, value in data_h5[key].items():
                            ...
                            if isinstance(value, np.ndarray) and np.issubdtype(value.dtype, np.str_):
                                # Create a special dtype for storing string data
                                str_dtype = h5py.string_dtype(encoding='utf-8')
                                group.create_dataset(subkey, data=value.astype(object), dtype=str_dtype)
                            else:
    ...
    for n,shot in enumerate(shots):
        if shot>=start_shot:
            try:
                ...
                data_h5_new['zdata']=np.array([data_h5[chord]['zdata'] for chord in chords])
